    ...
    UINT idNewItems, LPCITEMIDLIST pidlFolder, UINT fFSFilter)
{
    ...
    //    if (pFMH->pidlFolder)
    //    {
    //        LPSHELLFOLDER psfDesktop = Desktop_GetShellFolder(TRUE);      // hello wiktor
    ...
    if (pFMH)
    {
        ...
        if (pidl)
        {
            ...
            if (pFMH->pidlAltFolder) {
                ...
                //if (pFMH->hdpaFMIAlt) {       //hello wiktor
