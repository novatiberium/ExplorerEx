...
//
int CALLBACK HTIList_FolderIDCompare(HTREEITEM hItem1, HTREEITEM hItem2, LPARAM lParam)
{
    LPOneTreeNode lpData1, lpData2;
    LPCSHITEMID lpszID1, lpszID2 = 0;
